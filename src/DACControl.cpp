...
bool DACControl::begin() {
    ...
    // Initialize the DAC without specifying the address
    // (The GP8413 library uses the default address internally)
    dac.begin();

    // Since there's no setI2CAddress method, we'll directly configure the DAC
